...
class AbstractFactory(ABC):
    ...
    , bu the product of one variant are incompatible with products of another.
    """
...
class ConcreteFactory1(AbstractFactory):
    """
    Concrete Factores produce a family of products that belong to a single variant.
...
class AbstractProductB(ABC):
    """
    Heres the base interface of another product. All products can interact with 
    each other, but proper interaction is possible only between products of
...
if __name__ == "__main__":
    """
    The client code can work with any conrete factory class.
    """

    print("Client: Testing client code with the first facotry type:")
